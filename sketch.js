...
//---------------------------------------
    ...
    button1.position(windowWidth/2,windowHeight/3);
    button1.mousePressed(myMexico); //en vez de mousePressed para touch es touchStarted   
    }    
    
    //--------------------------------------------------------------------------------------------------
    if (magnitude >= 8.5 || magnitude < 9){
//--------------------------------------        
        //CREATE THE ELLIPSE AREA
    var x = width/2;
    var y = height/2;
...
//---------------------------------------
    ...
    button1 = createButton("See results");
    button1.position(windowWidth/2,windowHeight/3);
    button1.mousePressed(myIndonesia); //en vez de mousePressed para touch es touchStarted   
    }    
    --------------------------------------------------------------------------------------------------------------------
        if (magnitude >= 9 || magnitude < 9.5){
//--------------------------------------        
        //CREATE THE ELLIPSE AREA
    var x = width/2;
    var y = height/2;
...
//---------------------------------------
    ...
    button1 = createButton("See results");
    button1.position(windowWidth/2,windowHeight/3);
    button1.mousePressed(myJapon); //en vez de mousePressed para touch es touchStarted   
    }    
    ---------------------------------------------------------------------------------------------------------------------
        if (magnitude >= 9.5){
//--------------------------------------        
...
//---------------------------------------
    ...
    button1 = createButton("See results");
    button1.position(windowWidth/2,windowHeight/3);
    button1.mousePressed(myChile); //en vez de mousePressed para touch es touchStarted   
    }    
    --------------------------------------------------------------------------------------------------------------------------
